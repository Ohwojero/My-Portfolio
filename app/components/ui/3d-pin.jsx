      ...
      <div className=" max-w-7xl h-full -mt-7 flex-none  inset-0">
        <div className="absolute top-0 inset-x-0  flex justify-center">
          <Link
            href={href}
            target={"_blank"}
            className="relative flex flex-nowrap space-x-2 items-center z-10 rounded-full bg-zinc-950 py-0.5 px-4 ring-1 ring-white/10 ">
            <span
        ...
        <div
          ...
          <>
            <motion.div
              ...
              className="absolute left-1/2 top-1/2 rounded-[50%] bg-sky-500/[0.08] shadow-[0_8px_16px_rgb(0_0_0/0.4)]"></motion.div>
            <motion.div
              initial={{
                opacity: 0,
                scale: 0,
