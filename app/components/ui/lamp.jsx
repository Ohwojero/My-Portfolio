    ...
    (<div
      ...
      <div
        ...
        <motion.div
          ...
          <div
            className="absolute  w-[100%] left-0 bg-slate-950 h-40 bottom-0  [mask-image:linear-gradient(to_top,white,transparent)]" />
          <div
            className="absolute  w-40 h-[100%] left-0 bg-slate-950  bottom-0  [mask-image:linear-gradient(to_right,white,transparent)]" />
        </motion.div>
        <motion.div
          initial={{ opacity: 0.5, width: "15rem" }}
          whileInView={{ opacity: 1, width: "30rem" }}
        ...
        <div
          className="absolute inset-auto  h-44 w-full -translate-y-[12.5rem] bg-slate-950 "></div>
      </div>
      <div className="relative max-w-7xl w-full  flex -translate-y-80 flex-col items-center px-5">
        {children}
      </div>
    </div>)
  );
